package ru.szhuvertsev.itmo.sd.stock
...
import ru.szhuvertsev.itmo.sd.stock.service.SharesPrice
...
class StockApplicationTests {
    ...
    fun `should increase company shares price`() {
        val companyName = "Default Company"
        ...
        val createCompanyResult = mvc.perform(
            postJson(
                ...
                mapOf(
                    ...
                    "sharesPrice" to initialSharesPrice.toPlainString()
                )
            )
        ...
        val companyId =
            mapper
                .readValue(createCompanyResult.response.contentAsString, ResponseBody::class.java)
                .company!!
    ...
    fun `user is able to buy shares and sell shares`() {
        ...
        var userShares = mapper.readValue(userSharesResult.response.contentAsString, ResponseBody::class.java).shares!!
            .let { mapper.readValue(it, Array<SharesPrice>::class.java) }
